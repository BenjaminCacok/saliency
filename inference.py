...
parser.add_argument("--path", type=str, default="C:/Users/18336/Documents/SJTUTIS/salicon/images/train")
parser.add_argument("--weight_path", type=str, default="./salicon.pt")
